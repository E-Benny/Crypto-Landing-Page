## Crypto Landing Page
This repository contains an HTML file that displays a psychedelic background promoting the landing page for a Crypto business. This page was designed using HTML, CSS and RWD.
...
## Live Version
To view the live version of the code without downloading the HTML file, please click on the CodePen link (https://codepen.io/E-Benny/pen/OJZyvXM).
